...
from sungen.dsl.dsl_pydantic_models import LMModuleDSLModel
from sungen.dsl.utils.dsl_signature_utils import _process_module_signatures, get_sig_key
from sungen.dsl.dsl_predict_module import DSLPredictModule
...
def _get_lm_module_instance(pipeline, rendered_args, step):
    ...
    Uses the DSLModule class from sungen.dspy_modules.dsl_module to handle dspy_modules defined in the pipeline YAML.
    """
